...
app.controller('appCtrl', function ($scope,$rootScope,$ionicPlatform,$ionicPopup, $cordovaMedia, $firebaseArray) {
  ...
  $ionicPlatform.ready(function(){
    ...
    $scope.showAlert = function() {
      var alertPopup = $ionicPopup.alert({
        title: 'ALert!',
        template: 'Dear User Please Wait till it loads It may Take 2 to 3 minutes to load stream. Depending on your Internet Connection',
        okType: 'button-assertive'

      });
      alertPopup.then(function(res) {
        $ionicPopup.alert({template:
          'Thank you',
          okType: 'button-assertive'
        });
      });
